    ...
    describe('constructor', function() {
      ...
      return describe('customization', function() {
        ...
        it("allows discoveryUrl to be set", function() {
          return runs(function() {
            return expect(unicornApi.discoveryUrl).toMatch(/unicorns.com\?api_key=stardust&timestamp=[0-9]+&api_token=[0-9a-f]+/);
          });
        });
        ...
        return it("converts apiKey to api_key and apiSecret to api_secret", function() {
          return runs(function() {
            expect(unicornApi.api_key).toBe('stardust');
            return expect(unicornApi.api_secret).toBe('rainbros');
          });
        });
      });
    });
  ...
  describe('SwaggerOperation', function() {
    ...
    describe("urlify", function() {
      beforeEach(function() {
        ...
        return wordnik.api_secret = window.api_secret;
      });
      ...
      it("throws an exception if path has unmatched arguments", function() {
        return runs(function() {
          var args;
          args = {};
      ...
      it("includes api_key, timestamp, and api_token", function() {
        return runs(function() {
          var m, t, token, url;
          ...
          return expect(url).toMatch("api_token=" + token);
        });
      });
      return it("allows customization of api_key, timestamp, and api_token", function() {
        return runs(function() {
          var url;
          ...
          url = operation.urlify(args);
          return expect(url).toMatch(/\bkey=.*\bt=.*\btoken=/);
        });
      });
    });
