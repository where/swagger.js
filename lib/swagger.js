  ...
  SwaggerOperation = (function() {
    ...
    SwaggerOperation.prototype.urlify = function(args, includeApiKey) {
      ...
      if (includeApiKey && (this.resource.api.api_key != null) && this.resource.api.api_key.length > 0) {
        ...
        if ((this.resource.api.api_secret != null) && this.resource.api.api_secret.length > 0) {
          args[this.apiSecretName] = this.resource.api.api_secret;
        }
      }
    ...
    SwaggerOperation.prototype.getMatchingParams = function(paramTypes, args, includeApiKey) {
      var matchingParams, name, param, t, token, value, _i, _len, _ref, _ref1;
      matchingParams = {};
      _ref = this.parameters;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        param = _ref[_i];
      ...
      if (includeApiKey && (this.resource.api.api_key != null) && this.resource.api.api_key.length > 0) {
        ...
        if ((this.resource.api.api_secret != null) && this.resource.api.api_secret.length > 0) {
          ...
          matchingParams[this.resource.api.apiTimestampName] = t;
          token = CryptoJS.SHA1(this.resource.api.api_secret + t).toString();
          matchingParams[this.resource.api.apiTokenName] = token;
        }
      }
