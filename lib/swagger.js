...
(function() {
  ...
  SwaggerApi = (function() {
    ...
    SwaggerApi.prototype.api_secret = null;
    ...
    function SwaggerApi(options) {
      ...
      this.apiTimestampName = options.apiTimestampName != null ? options.apiTimestampName : 'timestamp';
      this.apiTokenName = options.apiTokenName != null ? options.apiTokenName : 'api_token';
      if (options.apiKey != null) {
        this.api_key = jQuery.trim(options.apiKey);
      }
      if (options.api_key != null) {
        this.api_key = jQuery.trim(options.api_key);
      }
      if (options.apiSecret != null) {
        this.api_secret = jQuery.trim(options.apiSecret);
      }
      if (options.api_secret != null) {
        this.api_secret = jQuery.trim(options.api_secret);
      }
    ...
    SwaggerApi.prototype.build = function() {
      ...
      return jQuery.getJSON(this.discoveryUrl, (function(_this) {
    ...
    SwaggerApi.prototype.getAPIKeyParams = function() {
      var params, t, token;
      params = {};
      if ((this.api_key != null) && this.api_key.length > 0) {
        params[this.apiKeyName] = this.api_key;
        if ((this.api_secret != null) && this.api_secret.length > 0) {
          t = (new Date()).getTime().toString();
          params[this.apiTimestampName] = t;
          token = CryptoJS.SHA1(this.api_secret + t).toString();
          params[this.apiTokenName] = token;
        }
      }
      return params;
    };
    ...
    SwaggerApi.prototype.suffixApiKey = function(url) {
      var params, sep;
      params = jQuery.param(this.getAPIKeyParams());
  ...
  SwaggerResource = (function() {
    function SwaggerResource(resourceObj, api) {
      ...
      if ((resourceObj.operations != null) && (this.api.resourcePath != null)) {
        ...
        jQuery.getJSON(this.url, (function(_this) {
          return function(response) {
            ...
            if ((response.resourceName != null) && jQuery.trim(response.resourceName).length > 0) {
              _this.name = response.resourceName;
            }
  ...
  SwaggerOperation = (function() {
    function SwaggerOperation(nickname, path, httpMethod, parameters, summary, notes, responseClass, errorResponses, resource, supportedContentTypes) {
      ...
      this.resource[this.nickname] = (function(_this) {
        return function(args, callback, error) {
    ...
    SwaggerOperation.prototype.getMatchingParams = function(paramTypes, args, includeApiKey) {
      ...
      if (includeApiKey) {
        jQuery.extend(matchingParams, this.resource.api.getAPIKeyParams());
      }
